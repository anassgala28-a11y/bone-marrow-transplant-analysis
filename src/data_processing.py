...
def preprocess_pipeline(filepath: str):
    ...
    # Drop post-transplant leakage features — these are only known AFTER
    # the transplant and must never be used as predictors
    leakage_cols = ["ANCrecovery", "PLTrecovery",
